...
<main>
    <div class="container">
        <div class="breadcrumb">
            ...
            <i class="fas fa-chevron-right"></i>
            {if $categoria}
            <a href="{$base_url}productosporcategoria/{$categoria->id_categoria}">{$categoria->nombre}</a>
            <i class="fas fa-chevron-right"></i>
            {/if}
        ...
        <div class="product-detail">
            ...
            <div class="product-info">
                ...
                <div class="product-description">
                    <h3>Descripción</h3>
                    <p>{if $producto->detalle}{$producto->detalle}{else}Producto de alta calidad diseñado para maximizar tu rendimiento deportivo.{/if}</p>
                </div>
        ...
        <div class="back-button">
            <a href="{$base_url}productos" class="btn btn-outline">
